...
public class SquareTheNewest {
    ...
    public static class SentencesItem implements Parcelable, MultiItemEntity {
        ...
        public String getContent() {
            return TextUtils.isEmpty(content) ? "没有内容？这是什么东西啊？" : content;
        }
        ...
        public String getWriter() {
            return TextUtils.isEmpty(writer) ? "佚名" : writer;
        }
        ...
        public String getArticle() {
            return TextUtils.isEmpty(article) ? "未知" : article;
        }
