...
public class SearchCommentRVAdapter extends BaseMultiItemQuickAdapter<SearchInfo.Comment, BaseViewHolder> {
    public SearchCommentRVAdapter(@Nullable List<SearchInfo.Comment> data) {
        super(data);
    ...
    @Override
    protected void convert(BaseViewHolder helper, SearchInfo.Comment item) {
